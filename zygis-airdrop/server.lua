--|___  /\ \   / / ____|_   _|/ ____|     /\   |_   _|  __ \|  __ \|  __ \ / __ \|  __ \ 
--   / /  \ \_/ / |  __  | | | (___      /  \    | | | |__) | |  | | |__) | |  | | |__) |
 -- / /    \   /| | |_ | | |  \___ \    / /\ \   | | |  _  /| |  | |  _  /| |  | |  ___/ 
-- / /__    | | | |__| |_| |_ ____) |  / ____ \ _| |_| | \ \| |__| | | \ \| |__| | |     
--/_____|   |_|  \_____|_____|_____/  /_/    \_\_____|_|  \_\_____/|_|  \_\\____/|_|   
...
RegisterNetEvent('esx:playerLoaded', function(playerId, xPlayer)
    TriggerClientEvent('zygis_airdrop:syncAirdrops', playerId, airdrops)
end)

RegisterNetEvent('zygis_airdrop:pickupAirdrop', function(id)
    local airdrop = GetAirdrop(id)

    if airdrop then
        RewardPlayer(source, airdrop.items)
        RemoveAirdrop(id)
        TriggerClientEvent('zygis_airdrop:removeObject', -1, id)
        TriggerClientEvent('zygis_airdrop:syncAirdrops', -1, airdrops)
    else
...
RegisterNetEvent('bryan_airdrop:airdropLanded', function(id)
...
SpawnAirdrop = function(lootTable, customCoords)
    ...
    if tryCount > 10 or not isLocationTaken or customCoords then
        ...
        if Config.Airdrops.DeletePrevious then
            TriggerClientEvent('zygis_airdrop:removeAllObjects', -1)
            airdrops = {}
        end
